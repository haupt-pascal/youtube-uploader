...
const uploadURL = 'https://bot.sannysoft.com'
...
async function uploadVideo(videoJSON: Video, messageTransport: MessageTransport) {
    ...
    do {
        ...
        uploadedLink = await page.evaluate((e) => e ? e.getAttribute('href') : null, uploadedLinkHandle);
